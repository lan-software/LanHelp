...
const authConfigContent = computed<TwoFactorConfigContent>(() => {
    if (showRecoveryInput.value) {
        return {
            title: t('auth.twoFactor.recoveryCode.layoutTitle'),
            description: t('auth.twoFactor.recoveryCode.layoutDescription'),
            buttonText: t('auth.twoFactor.recoveryCode.switchButton'),
        };
    }

    return {
        title: t('auth.twoFactor.authCode.layoutTitle'),
        description: t('auth.twoFactor.authCode.layoutDescription'),
