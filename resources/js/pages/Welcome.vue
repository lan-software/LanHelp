    ...
    <div class="flex min-h-screen flex-col bg-background text-foreground">
        <header class="mx-auto flex w-full max-w-5xl items-center justify-between px-6 py-6">
            <div class="flex items-center gap-3">
                ...
                <span class="text-lg font-semibold tracking-tight">LanHelp</span>
            </div>
            <div class="flex items-center gap-3">
                <Link
                    href="/kb"
        ...
        <main class="flex flex-1 flex-col items-center justify-center px-6 text-center">
            ...
            <p class="mt-4 max-w-lg text-lg leading-relaxed text-muted-foreground">
                LanHelp is the support hub for your LAN event. Submit tickets, browse the knowledge base, and get answers from event staff — all in one place.
            </p>
            ...
            <div class="mx-auto mt-20 grid max-w-3xl gap-6 sm:grid-cols-3">
                <div class="rounded-xl border border-border bg-card p-6 text-left">
                    <div class="mb-3 flex h-10 w-10 items-center justify-center rounded-lg bg-primary/10">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-primary" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="M10 12h4"/><path d="M10 16h4"/></svg>
                    </div>
                    <h3 class="text-sm font-semibold">Ticket System</h3>
                    <p class="mt-2 text-sm leading-relaxed text-muted-foreground">Submit support requests, track status, and communicate with staff directly.</p>
                </div>
                <div class="rounded-xl border border-border bg-card p-6 text-left">
                    <div class="mb-3 flex h-10 w-10 items-center justify-center rounded-lg bg-primary/10">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-primary" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H19a1 1 0 0 1 1 1v18a1 1 0 0 1-1 1H6.5a1 1 0 0 1 0-5H20"/></svg>
                    </div>
                    <h3 class="text-sm font-semibold">Knowledge Base</h3>
                    <p class="mt-2 text-sm leading-relaxed text-muted-foreground">Browse FAQs and guides published by organizers. Find answers fast.</p>
                </div>
                <div class="rounded-xl border border-border bg-card p-6 text-left">
                    <div class="mb-3 flex h-10 w-10 items-center justify-center rounded-lg bg-primary/10">
                    ...
                    <p class="mt-2 text-sm leading-relaxed text-muted-foreground">Event staff can assign, triage, and resolve tickets from a kanban board.</p>
                </div>
            </div>
        </main>
